...
A/B testing would be essential since it fits neatly within BEACON's layered architecture, and allowing a direct comparison of design choices that could not be compared in this simulation-only project.
For example, algorithms like EN-MASCA (\cite{ENMASCA2025}) could be effectively tested against BEACON's current path-planning approach, and a more traditional interface design could be tested against BEACON's aviation-inspired design.

NASA-TLX should be administered alongside measurements of alert burden, amount of manual interventions per minute, detected anomaly count, and other related metrics, to evaluate the impact of BEACON's design on workload and performance in a way that captures both perceived strain and mission outcomes.
While this work is beyond the scope of this project, it is essential to validate BEACON's design and evaluation framework.
