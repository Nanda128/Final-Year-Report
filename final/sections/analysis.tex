...
BEACON's design is grounded in the premise that autonomy and interface design can be evaluated through their impact on workload in addition to their impact on performance.
Simulation and internal testing suggests that BEACON's design choice of shifting from low-level control to high-level tasking, combined with a structured alert system, and transparent coverage visualization helps reduce the need for continuous management.
...
\subsection{NASA-TLX and Metric Design}\label{subsec:nasa-tlx-and-metric-design}
