...
This project combines a weighted Voronoi Tessellation approach to generate ``cells'' on the map, which are assigned to drones based on their position, and their speed, in such a manner that every drone completes their task at roughly the same time.
