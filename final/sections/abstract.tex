\begin{abstract}
    Maritime Search and Rescue (MSAR) operations demand rapid decisions while under significant pressure.
    ...
    These metrics are displayed with an optional National Aeronautics and Space Administration Task Load Index (NASA-TLX) workload assessment to provide a comprehensive view of both system performance and operator workload, because objective mission metrics alone cannot capture perceived operator strain.
