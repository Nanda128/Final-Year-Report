...
Design-science research focuses on building and evaluating artefacts that solve identified problems, while User-Centered Design (UCD) emphasizes grounded design decisions in user needs and preferences.
...
For example, Alerts were implemented as a feature, with the acceptance criteria noting the need for finding a standard to prioritize and display alerts, and the need for a visual and audio component to the alert system.


\subsection{Objectives and Hypotheses}\label{subsec:objectives-and-hypotheses}

To tie BEACON's design and evaluation to specific, verifiable hypotheses, we defined three research questions.
...
\begin{itemize}
    ...
    \item How much does BEACON's interface optimizations to improve situational awareness improve mission success?
\end{itemize}

From these, we can derive the following hypotheses:
...
\begin{itemize}
    ...
    \item Workload, as measured by NASA-TLX, will increase in high-stress scenarios, but will remain roughly within acceptable limits for MSAR operations.
...
The architecture of the system emphasizes domain purity, implementing clear separations between different, modular components of a larger system.
...
This trade-off facilitates a focus on HCI rather than physical modelling.
