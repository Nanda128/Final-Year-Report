...
This organization choice supports rapid transitions between different stages of the workflow, like mission controls, performance analysis, and scenario configuration.
...
The entire application's color scheme is defined centrally by ``Theme Tokens'' which are used to define the colors of all elements in the interface, such as the text, alerts, and controls.
Status colors still follow the same semantics, with red representing warnings, amber representing caution, and green representing normal.

Accessibility provisions include support for color-blind users by ensuring that critical information is conveyed through more channels than just color, like audio cues, and text.
