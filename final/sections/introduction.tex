...
BEACON (Behavioural Engine for Autonomous Coordination in Ocean Navigation) aims to explore how DT-inspired architectures and HCI principles can be combined to support a single operator supervising a co-ordinated swarm of autonomous drones, in an MSAR-like scenario.
