...
\begin{enumerate}
    ...
    \item \textbf{Swarm-Level Coordination Layer:} This layer manages the collective behaviour of the drone swarm.
    ...
    Search area coverage can also be optimised at this layer, using techniques like Voronoi Tessellations to optimally divide the search area among individual drones.
    ...
    The interface could potentially provide a map-based visualisation of drone positions, across an operational area.
