...
By maintaining a synchronised virtual representation of physical Unmanned Vehicle swarms, DTs could enable increased abstraction, easing cognitive loads on operators, in addition to potentially enabling predictive analysis, scenario-testing, and autonomous decision-making.
...
The swarm, and individual drones, are then represented through high-fidelity virtual replicas incorporating real-time state synchronisation, which would become the framework's Digital Layer.
...
\subsection{Report Organisation}\label{subsec:report-organization}
